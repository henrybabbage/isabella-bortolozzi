...
export const exhibitionImagesBySlugQuery = groq`*[_type == "exhibition" && slug.current == $slug][0]
    {
        imageGallery[]{
            ${imageComplete},
        }
...
export const aboveTheFoldImageBySlugQuery = groq`*[_type == $_type && slug.current == $slug][0]
    {
        imageGallery[0]{
            alt,
            asset->{
