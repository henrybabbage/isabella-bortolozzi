...
export const exhibitionQuery = groq`*[_type == 'exhibition' && slug.current == $slug && !(_id in path('drafts.**'))][0]
    {
        _id,
        _type,
        "slug": slug.current,
...
export const artistQuery = groq`*[_type == 'artist' && slug.current == $slug][0]
    {
        _type,
        artistBio1{
            ...
...
export const viewingRoomQuery = groq`*[_type == 'viewingRoom' && slug.current == $slug && !(_id in path('drafts.**'))][0]
    {
        _id,
        _type,
        "slug": slug.current,
