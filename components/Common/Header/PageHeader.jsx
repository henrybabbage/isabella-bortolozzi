...
export default function PageHeader({ title, children }) {
  return (
    <section className="fixed bg-background h-auto z-50 top-0 grid w-screen grid-cols-12 px-4 pt-6 pb-1 sm:pt-0 sm:pb-0">
      ...
      <div className="sm:col-span-1 sm:col-start-12 col-span-1 col-start-12 pt-14 sm:pt-4">
