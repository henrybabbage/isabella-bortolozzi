  ...
  return (
    <DynamicLink link={exhibition} scroll={false}>
      <div
        ref={ref}
        className={cn(
          '-z-50 text-primary group relative flex flex-col sm:grid h-[40rem] sm:h-[10.25vw] sm:max-h-[10.25vw] cursor-pointer sm:grid-cols-12 px-6 content-start pt-1 sm:pt-0 sm:pb-6 text-left',
          '',
        )}
      >
        ...
        >
          <div className="flex flex-col sm:col-span-3 sm:col-start-7 pt-6 sm:pt-3 w-fit">
            {exhibition.title && (
              <h1 className="text-primary uppercase pr-2">
                {exhibition.title}
              </h1>
            )}
            {exhibition.subtitle && (
          ...
          <div className="sm:col-span-3 sm:col-start-7 pt-6 sm:pt-3 w-fit">
