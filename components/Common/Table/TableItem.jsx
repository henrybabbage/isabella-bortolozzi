  ...
  return (
    <DynamicLink link={exhibition} scroll={false}>
      <div
        ref={ref}
        className={cn(
          '-z-50 text-primary group relative flex flex-col sm:grid h-[40rem] sm:h-[10.25vw] sm:max-h-[10.25vw] cursor-pointer sm:grid-flow-dense sm:grid-cols-12 px-6 content-start pt-1 sm:pt-0 sm:pb-6 text-left',
          '',
        )}
      >
