...
export default function ArtworkDrawer({ drawerIsOpen, setDrawerIsOpen, didClickPrevious, didClickNext, tabletOrMobile }) {
    ...
    return (
        <section
			className={cn(
                tabletOrMobile ? 'static' : 'relative',
                drawerIsOpen ? 'opacity-100' : 'opacity-0',
                'pointer-events-auto z-100 flex h-full w-full flex-col place-content-end bg-background p-6')}
		>
