...
const ImageSection = forwardRef(function ImageSection(
  { exhibition, scrollToSections, isLoading, index },
  ref,
) {
  ...
  return (
    <Fragment ref={ref}>
      <section
        ref={inViewRef}
        className="relative flex flex-col w-screen items-center gap-32"
      >
        {exhibition &&
          exhibition.imageGallery &&
          exhibition.imageGallery.map((image, idx) =>
            idx === 0 ? (
              <FullBleedImage
